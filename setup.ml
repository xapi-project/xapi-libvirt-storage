...
(* OASIS_START *)
(* DO NOT EDIT (digest: 19ec1ac8ff53292cc6cf8e541cd877a0) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          authors = ["David Scott"];
          homepage = None;
          synopsis = "xapi to libvirt storage adapter";
          description = None;
          categories = [];
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\154(\191\193\030\027\212Y\139n\238\143ab\017\234";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
